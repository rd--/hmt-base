...
module Music.Theory.Colour.Crayola where

import qualified Data.Colour.SRGB as Srgb {- colour -}

{- | Crayola colour table, (Name, HexString).
...
crayola_colour_table_srgb :: [(String, Srgb.Colour Double)]
crayola_colour_table_srgb =
  let f (nm, hx) = (nm, Srgb.sRGB24read hx)
