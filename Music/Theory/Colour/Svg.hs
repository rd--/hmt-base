-- | Svg colours
module Music.Theory.Colour.Svg where
...
svg_name_to_colour :: String -> Maybe (C.Colour Double)
svg_name_to_colour = N.readColourName

svg_name_to_colour_err :: String -> C.Colour Double
svg_name_to_colour_err = fromMaybe (error "svg_name_to_colour") . svg_name_to_colour

{- | The named colours of the @Svg@ specification, alphabetical order.
  <https://www.w3.org/TR/Svg11/types.html#ColorKeywords>

>>> length svg_colour_data
147
-}
