...
> g 3 100 60 == [(0,0),(100,0),(50,87),(0,0)] -- equilateral triangle
> g 4 100 90 == [(0,0),(100,0),(100,100),(0,100),(0,0)] -- square
> g 5 100 108 == [(0,0),(100,0),(131,95),(50,154),(-31,95),(0,0)] -- pentagon
> g 6 100 120 == [(0,0),(100,0),(150,87),(100,173),(0,173),(-50,87),(0,0)] -- hexagon
> g 7 100 (900/7) == [(0,0),(100,0),(162,78),(140,176),(50,219),(-40,176),(-62,78),(0,0)]
> g 8 100 135 == [(0,0),(100,0),(171,71),(171,171),(100,241),(0,241),(-71,171),(-71,71),(0,0)]

> r =  [(0,0),(30,0),(30,82),(-43,82),(-55,23),(0,0)]
> f (zip [30,82.24,73.27,60,60] [90,90,101.5,101.5,157]) == r
-}
...
> rnd = map (v2_map round)
> u i j = rnd (polygon_unfold_dgr ((0,0),0) (zip i j))
> u [100,100,100] [60,60,60] == [(0,0),(100,0),(50,87),(0,0)]

> phi = (1 + sqrt 5) / 2
> f i = u (map (* 100) i)
> f [1,1,phi-1] (map (* (180 / 5)) [1,2,2]) == [(0,0),(100,0),(19,59),(0,0)]
> f [1,phi,1] (map (* (180 / 5)) [1,1,3]) == [(0,0),(100,0),(-31,95),(0,0)]

> p = unzip . map (Data.Bifunctor.bimap round round) . polygon_param_dgr
> p [(0,0),(100,0),(19,59),(0,0)] == ([100,100,62],[36,72,72])
> p [(0,0),(100,0),(-31,95),(0,0)] == ([100,162,100],[36,36,108])

> p [(0,0),(62,0),(31,95),(-50,36),(0,0)] == ([62,100,100,62],[72,72,72,144])
> p [(0,0),(62,0),(-19,59),(-50,-36),(0,0)] == ([62,100,100,62],[36,72,36,216])
-}
...
> h [(0,0),(100,0),(50,87),(0,0)] == ([100,100,100],[60,60,60])
> h [(0,0),(100,0),(100,100),(0,100),(0,0)] == ([100,100,100,100],[90,90,90,90])
> h [(0,0),(100,0),(131,95),(50,154),(-31,95),(0,0)] == ([100,100,100,100,100],[108,108,108,108,108])
> h [(0,0),(30,0),(30,82),(-43,82),(-55,23),(0,0)] == ([30,82,73,60,60],[90,90,101,101,157])

> phi = (1 + sqrt 5) / 2
> kite = polygon_unfold_dgr ((0,0),0) (zip (map (* 100) [1/phi,1,1,1/phi]) [72,72,72,144])
> h kite == ([62,100,100,62],[72,72,72,144])
-}
